...
export const FEED_INFO_LIST: FeedInfo[] = createFeedInfoList([
  ...
  ['Qiita（機械学習タグ）', 'https://qiita.com/tags/機械学習/feed.atom'],
  ['Qiita（AIタグ）', 'https://qiita.com/tags/ai/feed.atom'],
  ['Qiita（生成AIタグ）', 'https://qiita.com/tags/生成ai/feed.atom'],
  ['Qiita（DLタグ）', 'https://qiita.com/tags/deeplearning/feed.atom'],
  ['Qiita（LLMタグ）', 'https://qiita.com/tags/llm/feed.atom'],
]);
